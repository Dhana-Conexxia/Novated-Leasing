...
The latest packages can be found in the [GitLab Package Registry](https://gitlab.com/appian-oss/appian-selenium-api/-/packages)

If you prefer a all-in-one Docker image, that can be found in the [Container Registry](https://gitlab.com/appian-oss/appian-selenium-api/container_registry)
