...
public class TempoSignatureField extends AppianObject implements WaitFor, WaitForReturn, Clickable {

  private static final Logger LOG = LogManager.getLogger(TempoSignatureField.class);
  private static final String XPATH_ABSOLUTE_SIGNATURE_BY_LABEL = Settings.getByConstant("xpathAbsoluteSignatureField");
  private static final String XPATH_ABSOLUTE_SIGNATURE_BY_INDEX = Settings.getByConstant("xpathAbsoluteSignatureFieldIndex");
  private static final String XPATH_ABSOLUTE_SIGNATURE_BY_LABEL_INDEX = "(" + XPATH_ABSOLUTE_SIGNATURE_BY_LABEL + ")[%2$d]";
  private static final String XPATH_RELATIVE_SIGNATURE_BUTTON = Settings.getByConstant("xpathRelativeSignatureButton");
  private static final String XPATH_ABSOLUTE_SIGNATURE_CANVAS = Settings.getByConstant("xpathAbsoluteSignatureCanvas");
  private static final String XPATH_ABSOLUTE_SIGNATURE_DONE_BUTTON = Settings.getByConstant("xpathAbsoluteSignatureDoneButton");
  ...
  public void waitFor(String... params) {
    ...
    if (LOG.isDebugEnabled()) LOG.debug("WAIT FOR SIGNATURE FIELD [" + index + "]");
  ...
  public void click(String... params) {
    ...
    if (LOG.isDebugEnabled()) LOG.debug("CLICK SIGNATURE FIELD BUTTON [" + label + "]");
  ...
  public void drawSignature() {
    ...
    if (LOG.isDebugEnabled()) LOG.debug("DRAW SIGNATURE");
  ...
  private void waitForSignatureCanvas() {
    if (LOG.isDebugEnabled()) LOG.debug("WAIT FOR SIGNATURE CANVAS");
