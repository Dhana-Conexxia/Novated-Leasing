...
public class TempoIconLink extends AppianObject implements Clickable {
  ...
  private static final String XPATH_ABSOLUTE_ICON_LINK_FIELD_ALTTEXT= Settings.getByConstant("xpathAbsoluteIconLinkFieldAltText");
  private static final String XPATH_ABSOLUTE_ICON_LINK_FIELD_ALTTEXT_INDEX= "(" + XPATH_ABSOLUTE_ICON_LINK_FIELD_ALTTEXT + ")[%2$d]";
  ...
  public void click(String... params) {
    ...
    if (LOG.isDebugEnabled()) LOG.debug("CLICK ICON LINK [" + altText + " " + indexNum + "]");
  ...
  public void waitFor(String... params) {
    String altText = getAltText(params);
    int indexNum = getIndexNumber(params);
    if (LOG.isDebugEnabled()) LOG.debug("WAIT FOR ICON LINK [" + altText + " " + indexNum + "]");
