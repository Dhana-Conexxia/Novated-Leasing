...
public class TempoSocialTaskItem extends AppianObject implements Refreshable, RegexCaptureable {
  ...
  protected static final String XPATH_ABSOLUTE_SOCIAL_TASK_ITEM = Settings.getByConstant("xpathAbsoluteSocialTaskItem");

  public static TempoSocialTaskItem getInstance(Settings settings) { return new TempoSocialTaskItem(settings); }
  ...
  public void waitFor(String... params) {
    ...
    if (LOG.isDebugEnabled()) LOG.debug("WAIT FOR [" + taskText + "]");
  ...
  public boolean waitForReturn(boolean waitForPresent, int timeout, String... params) {
    ...
    if (LOG.isDebugEnabled()) LOG.debug("WAIT FOR REFRESH [" + taskText + "]");
  ...
  public String regexCapture(String regex, Integer group, String... params) {
    ...
    if (LOG.isDebugEnabled()) LOG.debug("SOCIAL TASK ITEM [" + taskText + "] REGEX [" + regex + "]");
