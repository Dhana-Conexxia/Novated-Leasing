...
public class Constants {
  ...
  public enum RemoteDriver {
    ...
    public String getBrowserIP() { return this.browserIP; }

    public String getBrowserPort() { return this.browserPort; }

    public String getBrowserName() { return this.browserName; }
    
    public String getBrowserProtocol() { return this.browserProtocol; }
  }
}
