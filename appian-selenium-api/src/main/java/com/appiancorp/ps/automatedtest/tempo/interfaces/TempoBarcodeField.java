...
public class TempoBarcodeField extends AbstractTempoField {

  private static final Logger LOG = LogManager.getLogger(TempoBarcodeField.class);
  private static final String XPATH_ABSOLUTE_BARCODE_FIELD_LABEL = Settings.getByConstant("xpathAbsoluteBarcodeFieldLabel");
  private static final String XPATH_ABSOLUTE_BARCODE_FIELD_INDEX = Settings.getByConstant("xpathAbsoluteBarcodeFieldIndex");
  private static final String XPATH_ABSOLUTE_BARCODE_FIELD_LABEL_INDEX = "(" + XPATH_ABSOLUTE_BARCODE_FIELD_LABEL + ")[%2$d]";
  private static final String XPATH_RELATIVE_BARCODE_FIELD_INPUT = Settings.getByConstant("xpathRelativeBarcodeFieldInput");
  private static final String XPATH_RELATIVE_MASKED_BARCODE_FIELD_INPUT = Settings.getByConstant("xpathRelativeMaskedBarcodeFieldInput");
  ...
  public String getXpath(String... params) {
    ...
    if (isFieldIndex(fieldName)) {
      ...
      return xpathFormat(XPATH_ABSOLUTE_BARCODE_FIELD_LABEL + TempoFieldFactory.XPATH_CONCAT_ANCESTOR_FIELD_LAYOUT, fieldName);
    }
  }
  ...
  public void waitFor(String... params) {
    ...
    if (LOG.isDebugEnabled()) LOG.debug("WAIT FOR BARCODE FIELD [" + fieldName + "]");
  ...
  public String capture(WebElement fieldLayout, String... params) {
    ...
    if (LOG.isDebugEnabled()) LOG.debug("BARCODE FIELD VALUE : " + value);
  ...
  public boolean contains(WebElement fieldLayout, String... params) {
    ...
    if (LOG.isDebugEnabled())
      LOG.debug("BARCODE FIELD COMPARISON : Field value [" + fieldValue + "] compared to Entered value [" + compareString + "]");
