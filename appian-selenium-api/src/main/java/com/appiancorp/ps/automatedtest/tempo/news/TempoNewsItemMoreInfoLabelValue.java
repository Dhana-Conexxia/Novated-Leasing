...
public class TempoNewsItemMoreInfoLabelValue extends TempoNewsItemMoreInfo implements WaitFor {
  ...
  public void waitFor(String... params) {
    ...
    try {
      (new WebDriverWait(settings.getDriver(), Duration.ofSeconds(settings.getTimeoutSeconds()))).until(ExpectedConditions.presenceOfElementLocated(By.xpath(xpathFormat(
