...
public class TempoStampField extends AppianObject implements Container, WaitForReturn, FieldLayoutVerifiable {
  ...
  private static final String XPATH_ABSOLUTE_STAMP_FIELD_LABEL = Settings.getByConstant("xpathAbsoluteStampFieldLabel");
  private static final String XPATH_ABSOLUTE_STAMP_FIELD_LABEL_INDEX = "(" + XPATH_ABSOLUTE_STAMP_FIELD_LABEL + ")[%2$d]";
  private static final String XPATH_ABSOLUTE_STAMP_FIELD_INDEX = Settings.getByConstant("xpathAbsoluteStampFieldIndex");
  ...
  public void waitFor(String... params) {
    ...
    if (LOG.isDebugEnabled()) LOG.debug("WAIT FOR STAMP FIELD [" + fieldName + "]");
  ...
  public boolean contains(WebElement fieldLayout, String... params) {
    ...
    try {
      WebElement element = fieldLayout.findElement(By.xpath(xpathFormat(XPATH_RELATIVE_STAMP_TEXT, expectedText)));
    } catch (Exception e) {
