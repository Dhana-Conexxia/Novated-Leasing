...
public class TempoCardChoice extends TempoContainer implements WaitFor, WaitForReturn, Clickable {
  ...
  private static final String XPATH_ABSOLUTE_CARD_CHOICE_INDEX = "(" + Settings.getByConstant("xpathAbsoluteCardChoice") + ")[%3$d]";
  ...
  public void click(String... params) {
    ...
    if (LOG.isDebugEnabled()) LOG.debug("CLICK [" + cardName + "]");
  ...
  public void waitFor(String... params) {
    ...
    if (LOG.isDebugEnabled()) LOG.debug("WAIT FOR CARD CHOICE [" + cardName + "] IN CARD CHOICE FIELD [" + fieldName + "]");
