...
public class TempoDocumentImageLink extends AppianObject implements Clickable {
  ...
  private static final String XPATH_ABSOLUTE_DOCUMENT_IMAGE_LINK_ALTTEXT= Settings.getByConstant("xpathAbsoluteDocumentImageLinkAltText");
  private static final String XPATH_ABSOLUTE_DOCUMENT_IMAGE_LINK_ALTTEXT_INDEX= "(" + XPATH_ABSOLUTE_DOCUMENT_IMAGE_LINK_ALTTEXT + ")[%2$d]";
  private static final String XPATH_ABSOLUTE_DOCUMENT_IMAGE_LINK= Settings.getByConstant("xpathAbsoluteDocumentImageLink");
  private static final String XPATH_ABSOLUTE_DOCUMENT_IMAGE_LINK_INDEX= "(" + XPATH_ABSOLUTE_DOCUMENT_IMAGE_LINK + ")[%1$d]";
  ...
  public void click(String... params) {
    ...
    if (LOG.isDebugEnabled()) LOG.debug("CLICK DOCUMENT IMAGE LINK [" + altText + " " + indexNum + "]");
  ...
  public void waitFor(String... params) {
    String altText = getAltText(params);
    int indexNum = getIndexNumber(params);
    if (LOG.isDebugEnabled()) LOG.debug("WAIT FOR DOCUMENT IMAGE LINK [" + altText + " " + indexNum + "]");
    ...
    try {
      ...
      throw ExceptionBuilder.build(e, settings, "Wait for Document Image Link", altText, String.valueOf(indexNum));
    }
  }
