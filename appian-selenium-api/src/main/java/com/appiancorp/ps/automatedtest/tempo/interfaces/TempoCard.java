...
public class TempoCard extends TempoContainer implements WaitFor, WaitForReturn, Clickable {
  ...
  private static final String XPATH_ABSOLUTE_CARD_INDEX = "(" + Settings.getByConstant("xpathAbsoluteCard") + ")[%2$d]";
  ...
  public void waitFor(String... params) {
    ...
    if (LOG.isDebugEnabled()) LOG.debug("WAIT FOR [" + cardName + "]");
  ...
  public boolean waitForReturn(boolean waitForPresent, int timeout, String... params) {
    ...
    if (LOG.isDebugEnabled()) LOG.debug("WAIT FOR CARD [" + cardName + "]");
