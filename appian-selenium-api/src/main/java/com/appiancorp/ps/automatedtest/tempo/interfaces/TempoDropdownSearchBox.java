...
public class TempoDropdownSearchBox extends TempoDropdownField implements WaitFor, Populateable {
  ...
  private static final String XPATH_ABSOLUTE_DROPDOWN_SEARCH_BOX_FIELD = Settings.getByConstant("xpathAbsoluteDropdownSearchBoxField");
  ...
  public void populate(String... params) {
    ...
    if (LOG.isDebugEnabled()) LOG.debug("SEARCH DROPDOWN [" + dropdownFieldName + "] FOR [" + searchValue + "]");
  ...
  public void waitFor(String... params) {
    ...
    if (LOG.isDebugEnabled()) LOG.debug("WAIT FOR DROPDOWN SEARCH BOX [" + dropdownFieldName + "]");
