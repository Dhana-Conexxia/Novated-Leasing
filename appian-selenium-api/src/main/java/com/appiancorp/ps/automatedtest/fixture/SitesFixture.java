...
public class SitesFixture extends TempoFixture {
   ...
   *          Web Address Identifier of Appian site
   * @param pageIdentifier
   *          Web Address Identifier of Page
   * @param groupIdentifier
   *          Web Address Identifier of the Group
   */
  public void navigateToSitePageInGroup(String siteIdentifier, String pageIdentifier, String groupIdentifier) {
    if (SitePage.getInstance(settings).atLeastVersion(23.3)) {
      ...
      throw new UnsupportedOperationException("navigateToSitePageInGroup is only supported for version 23.3 and later");
    }
  }
   ...
   * @param sitePage
   *          Name of the Appian Site Page
   * @param group
   *          Name of the group the Site Page is located under
   */
  public void clickOnSitePageInGroup(String sitePage, String group) {
    if (SitePage.getInstance(settings).atLeastVersion(23.3)) {
      ...
      throw new UnsupportedOperationException("clickOnSitePageInGroup is only supported for version 23.3 and later");
    }
  }
