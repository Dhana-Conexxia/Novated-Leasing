...
public class TempoGridCell extends TempoGrid implements
  ...
  private static final String XPATH_ABSOLUTE_GRID_COLUMN_LABELS = Settings.getByConstant("xpathRelativeColumnLabelCount");
  ...
  protected WebElement getGridWebElement(WebElement grid, String...params) {
    ...
    if (LOG.isDebugEnabled()) LOG.debug("WAIT FOR COLUMN [" + columnName + "] ROW [" + rowNum + "]");
