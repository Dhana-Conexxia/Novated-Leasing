...
public abstract class AbstractTempoField extends AppianObject implements Container, FieldLayoutPopulateable, FieldLayoutVerifiable,
  ...
  public static final String XPATH_ABSOLUTE_FIELD_LAYOUT_PLACEHOLDER = Settings.getByConstant("xpathAbsoluteFieldLayoutPlaceholder");
  public static final String XPATH_ABSOLUTE_FIELD_LAYOUT_INSTRUCTIONS = Settings.getByConstant("xpathAbsoluteFieldLayoutInstructions");
  public static final String XPATH_ABSOLUTE_FIELD_LAYOUT_TOOLTIP = Settings.getByConstant("xpathAbsoluteFieldLayoutTooltip");
  ...
  public String getXpath(String... params) {
    ...
    if (fieldName.startsWith(Constants.FIELD_LOCATOR_PLACEHOLDER)) {
      return xpathFormat(XPATH_ABSOLUTE_FIELD_LAYOUT_PLACEHOLDER, fieldName.replace(Constants.FIELD_LOCATOR_PLACEHOLDER, ""));
    } else if (fieldName.startsWith(Constants.FIELD_LOCATOR_INSTRUCTIONS)) {
      return xpathFormat(XPATH_ABSOLUTE_FIELD_LAYOUT_INSTRUCTIONS, fieldName.replace(Constants.FIELD_LOCATOR_INSTRUCTIONS, ""));
    } else if (fieldName.startsWith(Constants.FIELD_LOCATOR_TOOLTIP)) {
      return xpathFormat(XPATH_ABSOLUTE_FIELD_LAYOUT_TOOLTIP, fieldName.replace(Constants.FIELD_LOCATOR_TOOLTIP, ""));
    } else {
