...
public class TempoGaugeField extends AbstractTempoField {
  ...
  private static final String XPATH_RELATIVE_GAUGE_FIELD_PERCENTAGE = Settings.getByConstant("xpathRelativeGaugeFieldPercentage");
  ...
  public void waitFor(String... params) {
    ...
    if (LOG.isDebugEnabled()) LOG.debug("WAIT FOR GAUGE FIELD [" + fieldName + "]");
