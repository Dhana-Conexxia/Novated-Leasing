...
public class TempoEncryptedTextField extends TempoTextField {
  ...
  public String capture(WebElement fieldLayout, String... params) {
    String value = fieldLayout.findElement(By.xpath(XPATH_RELATIVE_ENCRYPTED_TEXT_FIELD_INPUT)).getAttribute("value");
