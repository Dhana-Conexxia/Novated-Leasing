...
public class TempoGridRow extends TempoGridCell implements Clickable, Verifiable, Countable {
  ...
  private static final String XPATH_RELATIVE_GRID_CHECKBOX_CLICK = Settings.getByConstant("xpathRelativeGridCheckboxClick");
  ...
  public boolean contains(String... params) {
    ...
    try {
      ...
      if (isRowSelectable(cell)) {
        String selectedAttributeValue = cell.findElement(By.xpath(XPATH_PARENT)).getAttribute(XPATH_ROW_SELECTED);
