...
public class TempoSocialTaskItemClose extends TempoSocialTaskItem implements Clickable {
  ...
  private static final String XPATH_ABSOLUTE_SOCIAL_TASK_ITEM_CLOSE = XPATH_ABSOLUTE_SOCIAL_TASK_ITEM + Settings.getByConstant("xpathConcatSocialTaskItemClose");
  private static final String XPATH_ABSOLUTE_SOCIAL_TASK_ITEM_CLOSE_COMMENT_BOX = XPATH_ABSOLUTE_SOCIAL_TASK_ITEM + Settings.getByConstant("xpathConcatSocialTaskItemCloseCommentBox");
  private static final String XPATH_ABSOLUTE_SOCIAL_TASK_ITEM_CLOSE_COMMENT_BUTTON = XPATH_ABSOLUTE_SOCIAL_TASK_ITEM + Settings.getByConstant("xpathConcatSocialTaskItemCloseCommentButton");
