...
public class TempoMilestoneField extends AbstractTempoField {
  ...
  private static final Version version = Settings.getVersion();
  ...
  private static final String XPATH_RELATIVE_STEP_VERTICAL = Settings.getByConstant("xpathRelativeMilestoneStepVerticalGeneral");
  private static final String XPATH_RELATIVE_STEP_SELECTED = Settings.getByConstant("xpathRelativeMilestoneStepSelected");
  private static final String XPATH_RELATIVE_STEP_SELECTED_VERTICAL = Settings.getByConstant("xpathRelativeMilestoneStepVerticalSelected");
  private static final String XPATH_CONCAT_PARENT_FIELD_LAYOUT = Settings.getByConstant("xpathConcatParentFieldLayout");
  ...
  public static boolean isType(WebElement fieldLayout) {
    return xpathExistsInField(XPATH_RELATIVE_STEP, fieldLayout) || xpathExistsInField(XPATH_RELATIVE_STEP_VERTICAL, fieldLayout);
  }
