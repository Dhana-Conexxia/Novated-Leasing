...
public class TempoClickableChart extends AppianObject implements Clickable {
  ...
  private static final String XPATH_ABSOLUTE_COLUMN_CHART_INDEX = Settings.getByConstant("xpathAbsoluteColumnChartIndex");
  ...
  public void click(String... params) {
    ...
    if (LOG.isDebugEnabled()) LOG.debug("CLICK " + chartType + " CHART [" + chartLabel + "] PART [" + itemIndexNumber + "]");
  ...
  public void waitFor(String... params) {
    ...
    if (LOG.isDebugEnabled()) LOG.debug("WAIT FOR " + chartType + " CHART [" + chartLabel + "] PART [" + itemIndexNumber + "]");
    ...
    switch (chartType.toUpperCase()) {
      ...
      default:
        throw ExceptionBuilder.build(
                new Exception("Expected chart type to be one of BAR, COLUMN, PIE, or LINE. Received: " + chartType),
                settings);
    }
  }
