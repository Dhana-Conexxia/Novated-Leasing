...
public class TempoButton extends AbstractTempoField implements WaitFor, Clickable {
  ...
  public String getXpath(String... params) {
    ...
    if (isFieldIndex(button)) {
      ...
      if (buttonName.contains(Constants.FIELD_LOCATOR_TOOLTIP)) {
        return xpathFormat(XPATH_ABSOLUTE_BUTTON_TOOLTIP_INDEX, buttonName.replace(Constants.FIELD_LOCATOR_TOOLTIP, ""), buttonIndex);
      } else {
  ...
  public boolean isEnabled(String... params) {
    ...
    if (LOG.isDebugEnabled()) LOG.debug("CHECK IF BUTTON [" + buttonName + "] IS ENABLED");
