...
public class TempoMenuWidget extends AppianObject implements Clickable {
  ...
  private static final String XPATH_ABSOLUTE_MENU_WIDGET_ITEM_TEXT = Settings.getByConstant("xpathAbsoluteMenuWidgetItemText");
  private static final String XPATH_ABSOLUTE_MENU_WIDGET_ITEM_TEXT_INDEX = "(" + XPATH_ABSOLUTE_MENU_WIDGET_ITEM_TEXT + ")[%2$d]";
  private static final String XPATH_ABSOLUTE_MENU_WIDGET_ITEM = Settings.getByConstant("xpathAbsoluteMenuWidgetItem");
  private static final String XPATH_ABSOLUTE_MENU_WIDGET_ITEM_INDEX = "(" + XPATH_ABSOLUTE_MENU_WIDGET_ITEM + ")[%1$d]";
  ...
  public void click(String... params) {
    ...
    if (LOG.isDebugEnabled()) LOG.debug("Click on tempo menu widget [" + menuText + "]");
  ...
  public void waitFor(String... params) {
    String menuText = getParam(0, params);
    if (LOG.isDebugEnabled()) LOG.debug("WAIT FOR tempo menu widget [" + menuText + "]");
    try {
