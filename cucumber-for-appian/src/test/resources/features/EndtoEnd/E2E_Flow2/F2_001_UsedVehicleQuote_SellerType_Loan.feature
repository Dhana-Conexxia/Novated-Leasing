...
Feature: Novated Driver creates a new Quote for a Used Vehicle (Seller Type - Loan)
  ...
  Scenario:Novated Driver creates a new Quote for a Used Vehicle (Seller Type - Loan)
    When I click on button "Request a Quote"
    When I click on text "Used Vehicle Quote"
    When I populate field "Model Year" with "2022"
    When I populate dropdown "Make" search box with "KIA"
    #When I populate field "Model" with "CERATO"
    ...
    When I populate field type "text" named "Registration Number" with "FLY33R"
    ...
    When I populate field type "text" named "Current Odometer Reading" with "100000"
    When I populate field "Date of Odometer Reading" with "21/11/2025"
    When I populate field "Build Date" with "31/12/2020"
    When I wait for "4" seconds
    When I populate field "Seller Type" with "Financier (Loan)"
    When I populate field "Loan Holder" with "Myself"
    When I populate field type "text" named "Total Vehicle Price Including Accessories" with "60000"
    When I wait for "6" seconds
    When I populate field "Payout Figure Due Date" with "13/12/2025"
