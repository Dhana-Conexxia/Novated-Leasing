...
public class CucumberTempoFixture {
  ...
  public void clickOnMenu(String tempoMenu) { fixture.clickOnMenu(tempoMenu); }

  @Given("^I click on menu widget \"([^\"]*)\"$")
  public void clickOnMenuWidget(String menuWidget) { fixture.clickOnMenuWidget(menuWidget); }

  @Given("^I search for \"([^\"]*)\"$")
  public void searchFor(String searchTerm) { fixture.searchFor(searchTerm); }

  @Given("^I clear search value$")
  public void clearSearchValue() { fixture.clearSearchValue(); }

  @Given("^I logout$")
  public void logout() { fixture.logout(); }
  ...
  public void toggleMoreInfoForNewsFeedContainingText(String newsText) { fixture.toggleMoreInfoForNewsFeedContainingText(newsText); }

  @Given("^I delete news post \"([^\"]*)\"$")
  public void deleteNewsPost(String newsText) { fixture.deleteNewsPost(newsText); }

  public void deleteAllNewsPosts() { fixture.deleteAllNewsPosts(); }
  ...
  public String getRegexGroupFromNewsFeedContainingText(String regex, String group, String newsText) { return fixture.getRegexGroupFromNewsFeedContainingText(regex, Integer.parseInt(group), newsText); }

  @Given("^I get regex \"([^\"]*)\" group \"([^\"]*)\" from news feed containing text \"([^\"]*)\" commented with \"([^\"]*)\"$")
  public String getRegexGroupFromNewsFeedContainingTextCommentedWith(String regex, String group, String newsText, String newsComment) { return fixture.getRegexGroupFromNewsFeedContainingTextCommentedWith(regex, Integer.parseInt(group), newsText, newsComment); }

  @Given("^I click on news feed \"([^\"]*)\" record tag \"([^\"]*)\"$")
  public void clickOnNewsFeedRecordTag(String newsText, String recordTag) { fixture.clickOnNewsFeedRecordTag(newsText, recordTag); }

  @Given("^I send kudos \"([^\"]*)\" to \"([^\"]*)\"$")
  public void sendKudosTo(String message, String recipient) { fixture.sendKudosTo(message, recipient); }

  @Given("^I send \"([^\"]*)\" message \"([^\"]*)\" to \"([^\"]*)\"$")
  public void sendMessageTo(String lockStatus, String message, List<String> recipients) { fixture.sendMessageTo(lockStatus, message, recipients); }

  @Given("^I send task \"([^\"]*)\" to \"([^\"]*)\"$")
  public void sendTaskTo(String message, String recipient) { fixture.sendTaskTo(message, recipient); }

  @Given("^I send post \"([^\"]*)\" to \"([^\"]*)\"$")
  public void sendPostTo(String message, List<String> participants) { fixture.sendPostTo(message, participants); }

  @Given("^I send post \"([^\"]*)\"$")
  public void sendPostTo(String message) { fixture.sendPost(message); }

  @Given("^I star post containing \"([^\"]*)\"$")
  public void starPostContaining(String newsText) { fixture.starPostContaining(newsText); }
  ...
  public void addCommentToPostContaining(String comment, String newsText) { fixture.addCommentToPostContaining(comment, newsText); }

  @Given("^I filter news on \"([^\"]*)\"$")
  public void filterNewsOn(String filterName) { fixture.filterNewsOn(filterName); }
  ...
  public void clickUserProfileCircleOnPostContaining(String newsText) { fixture.clickUserProfileCircleOnPostContaining(newsText); }

  @Given("^I click user profile link on post containing \"([^\"]*)\"$")
  public void clickUserProfileLinkOnPostContaining(String newsText) { fixture.clickUserProfileLinkOnPostContaining(newsText); }
  ...
  public void closeSocialTaskContainingWithComment(String comment, String taskText) { fixture.closeSocialTaskContainingWithComment(comment, taskText); }

  public void sortByNewest() { fixture.sortByNewest(); }

  public void sortByOldest() { fixture.sortByOldest(); }

  public boolean verifySortLabel(String value) { return fixture.verifySortLabel(value); }

  @Given("^I click on task \"([^\"]*)\"$")
  public void clickOnTask(String taskName) { fixture.clickOnTask(taskName); }

  @Given("^I get regex \"([^\"]*)\" group \"([^\"]*)\" from task name containing text \"([^\"]*)\"$")
  public String getRegexGroupFromTaskNameContainingText(String regex, String group, String taskText) { return fixture.getRegexGroupFromTaskNameContainingText(regex, Integer.parseInt(group), taskText); }
  ...
  public void clickOnTaskReport(String taskReport) { fixture.clickOnTaskReport(taskReport); }

  @Given("^I accept task$")
  public void acceptTask() { fixture.acceptTask(); }

  @Given("^I click on record type \"([^\"]*)\"$")
  public void clickOnRecordType(String typeName) { fixture.clickOnRecordType(typeName); }

  @Given("^I populate record type user filter \"([^\"]*)\" with \"([^\"]*)\"$")
  public void populateRecordTypeUserFilterWith(String userFilter, String value) { fixture.populateRecordTypeUserFilterWith(userFilter, value); }

  @Given("^I clear record type user filter \"([^\"]*)\"$")
  public void clearRecordTypeUserFilter(String userFilter) { fixture.clearRecordTypeUserFilter(userFilter); }

  @Given("^I click on record \"([^\"]*)\"$")
  public void clickOnRecord(String recordName) { fixture.clickOnRecord(recordName); }

  @Given("^I get regex \"([^\"]*)\" group \"([^\"]*)\" from record name containing text \"([^\"]*)\"$")
  public String getRegexGroupFromRecordNameContainingText(String regex, String group, String recordText) { return fixture.getRegexGroupFromRecordNameContainingText(regex, Integer.parseInt(group), recordText); }
  ...
  public void clickOnRecordView(String viewName) { fixture.clickOnRecordView(viewName); }

  @Given("^I click on record related action \"([^\"]*)\"$")
  public void clickOnRecordRelatedAction(String relatedActionName) { fixture.clickOnRecordRelatedAction(relatedActionName); }
  ...
  public String getGridIndex(String headers) { return fixture.getGridIndex(headers); }

  @Given("^I sort record grid by column \"([^\"]*)\"$")
  public void sortRecordGridByColumn(String columnName) { fixture.sortRecordGridByColumn(columnName); }

  @Given("^I click on record grid navigation \"([^\"]*)\"$")
  public void clickOnRecordGridNavigation(String navOption) { fixture.clickOnRecordGridNavigation(navOption); }

  @Given("^I click on report \"([^\"]*)\"$")
  public void clickOnReport(String reportName) { fixture.clickOnReport(reportName); }
  ...
  public void clickOnAction(String actionName) { fixture.clickOnAction(actionName); }

  @Given("^I star action \"([^\"]*)\"$")
  public void starAction(String actionName) { fixture.starAction(actionName); }
  ...
  public void clickOnApplicationFilter(String appFilter) { fixture.clickOnApplicationFilter(appFilter); }
  ...
  public String getFormTitle() { return fixture.getFormTitle(); }

  @Given("^I get regex \"([^\"]*)\" group \"([^\"]*)\" from form title$")
  public String getRegexGroupFromFormTitle(String regex, String group) { return fixture.getRegexGroupFromFormTitle(regex, Integer.parseInt(group)); }

  @Given("^I get form instructions$")
  public String getFormInstructions() { return fixture.getFormInstructions(); }

  @Given("^I populate field \"([^\"]*)\" with$")
  public void populateFieldWith(String fieldName, List<String> fieldValues) { fixture.populateFieldWith(fieldName, parseListToArray(fieldValues)); }

  @Given("^I populate field \"([^\"]*)\" with \"([^\"]*)\"$")
  public void populateFieldWith(String fieldName, String fieldValue) { fixture.populateFieldWith(fieldName, new String[] {fieldValue}); }
  ...
  public void populateFieldWith(String fieldType, String fieldName, List<String> fieldValues) { fixture.populateFieldWith(fieldType, fieldName, parseListToArray(fieldValues)); }

  @Given("^I populate field type \"([^\"]*)\" named \"([^\"]*)\" with \"([^\"]*)\"$")
  public void populateFieldWith(String fieldType, String fieldName, String fieldValue) { fixture.populateFieldWith(fieldType, fieldName, new String[] {fieldValue}); }

  @Given("^I populate field \"([^\"]*)\" with value \"([^\"]*)\"$")
  public void populateFieldWithValue(String fieldName, String fieldValue) { fixture.populateFieldWithValue(fieldName, fieldValue); }

  @Given("^I populate field \"([^\"]*)\" in section \"([^\"]*)\" with$")
  public void populateFieldInSectionWith(String fieldName, String sectionName, List<String> fieldValues) { fixture.populateFieldInSectionWith(fieldName, sectionName, parseListToArray(fieldValues)); }

  @Given("^I populate field \"([^\"]*)\" in section \"([^\"]*)\" with \"([^\"]*)\"$")
  public void populateFieldInSectionWith(String fieldName, String sectionName, String fieldValue) { fixture.populateFieldInSectionWith(fieldName, sectionName, new String[] {fieldValue}); }

  @Given("^I toggle section \"([^\"]*)\" visibility$")
  public void toggleSectionVisibility(String sectionName) { fixture.toggleSectionVisibility(sectionName); }

  @Given("^I toggle box \"([^\"]*)\" visibility$")
  public void toggleBoxVisibility(String boxName) { fixture.toggleBoxVisibility(boxName); }

  @Given("^I clear field \"([^\"]*)\"$")
  public void clearField(String fieldName) { fixture.clearField(fieldName); }

  @Given("^I clear field \"([^\"]*)\" of$")
  public void clearFieldOf(String fieldName, List<String> fieldValues) { fixture.clearFieldOf(fieldName, parseListToArray(fieldValues)); }

  @Given("^I clear field \"([^\"]*)\" of \"([^\"]*)\"$")
  public void clearFieldOf(String fieldName, String fieldValue) { fixture.clearFieldOf(fieldName, new String[] {fieldValue}); }
  ...
  public String getFieldValue(String fieldName) { return fixture.getFieldValue(fieldName); }

  @Given("^I get regex \"([^\"]*)\" group \"([^\"]*)\" from field \"([^\"]*)\" value$")
  public String getRegexGroupFromFieldValue(String regex, String group, String fieldName) { return fixture.getRegexGroupFromFieldValue(regex, Integer.parseInt(group), fieldName); }

  @Given("^I get field \"([^\"]*)\" in section \"([^\"]*)\" value$")
  public String getFieldInSectionValue(String fieldName, String sectionName) { return fixture.getFieldInSectionValue(fieldName, sectionName); }

  @Given("^I get regex \"([^\"]*)\" group \"([^\"]*)\" from field \"([^\"]*)\" in section \"([^\"]*)\" value$")
  public String getRegexGroupFromFieldInSectionValue(String regex, String group, String fieldName, String sectionName) { return fixture.getRegexGroupFromFieldInSectionValue(regex, Integer.parseInt(group), fieldName, sectionName); }
  ...
  public String getFieldValidationMessage(String fieldName) { return fixture.getFieldValidationMessage(fieldName); }
  ...
  public void populateGridColumnRowWith(String gridName, String columnName, String rowNum, List<String> fieldValues) { fixture.populateGridColumnRowWith(gridName, columnName, rowNum, parseListToArray(fieldValues)); }

  @Given("^I populate grid \"([^\"]*)\" column \"([^\"]*)\" row \"([^\"]*)\" with \"([^\"]*)\"$")
  public void populateGridColumnRowWith(String gridName, String columnName, String rowNum, String fieldValue) { fixture.populateGridColumnRowWith(gridName, columnName, rowNum, new String[] {fieldValue}); }

  @Given("^I populate grid \"([^\"]*)\" column \"([^\"]*)\" row \"([^\"]*)\" with partially matching picker field suggestions for$")
  public void populateGridColumnRowWithPartiallyMatchingPickerFieldSuggestion(String gridName, String columnName, String rowNum, List<String> fieldValues) {
    fixture.populateGridColumnRowWithPartiallyMatchingPickerFieldSuggestion(gridName, columnName, rowNum, parseListToArray(fieldValues));
  }

  @Given("^I populate grid \"([^\"]*)\" column \"([^\"]*)\" row \"([^\"]*)\" with partially matching picker field suggestions for \"([^\"]*)\"$")
  public void populateGridColumnRowWithPartiallyMatchingPickerFieldSuggestion(String gridName, String columnName, String rowNum, String fieldValue) {
    fixture.populateGridColumnRowWithPartiallyMatchingPickerFieldSuggestion(gridName, columnName, rowNum, new String[] {fieldValue});
  }

  @Given("^I populate grid \"([^\"]*)\" column \"([^\"]*)\" row \"([^\"]*)\" with value \"([^\"]*)\"$")
  public void populateGridColumnRowWithValue(String gridName, String columnName, String rowNum, String fieldValue) { fixture.populateGridColumnRowWithValue(gridName, columnName, rowNum, fieldValue); }

  @Given("^I clear grid \"([^\"]*)\" column \"([^\"]*)\" row \"([^\"]*)\"$")
  public void clearGridColumnRow(String gridName, String columnName, String rowNum) { fixture.clearGridColumnRow(gridName, columnName, rowNum); }

  @Given("^I click on grid \"([^\"]*)\" column \"([^\"]*)\" row \"([^\"]*)\"$")
  public void clickOnGridColumnRow(String gridName, String columnName, String rowNum) { fixture.clickOnGridColumnRow(gridName, columnName, rowNum); }

  @Given("^I get grid \"([^\"]*)\" column \"([^\"]*)\" row \"([^\"]*)\" value$")
  public String getGridColumnRowValue(String gridName, String columnName, String rowNum) { return fixture.getGridColumnRowValue(gridName, columnName, rowNum); }

  @Given("^I get regex \"([^\"]*)\" group \"([^\"]*)\" from grid \"([^\"]*)\" column \"([^\"]*)\" Row \"([^\"]*)\" value$")
  public String getRegexGroupFromGridColumnRowValue(String regex, String group, String gridName, String columnName, String rowNum) { return fixture.getRegexGroupFromGridColumnRowValue(regex, Integer.parseInt(group), gridName, columnName, rowNum); }

  @Given("^I verify grid \"([^\"]*)\" column \"([^\"]*)\" row \"([^\"]*)\" contains$")
  public boolean verifyGridColumnRowContains(String gridName, String columnName, String rowNum, List<String> fieldValues) {
  ...
  public void selectGridRow(String gridName, String rowNum) { fixture.selectGridRow(gridName, rowNum); }
  ...
  public Integer countGridRows(String gridName) { return fixture.countGridRows(gridName); }

  @Given("^I get grid \"([^\"]*)\" total count$")
  public int getGridTotalCount(String gridName) { return fixture.getGridTotalCount(gridName); }

  @Given("^I get grid \"([^\"]*)\" row count$")
  public int getGridRowCount(String gridName) { return fixture.getGridRowCount(gridName); }

  @Given("^I click on grid \"([^\"]*)\" add row link$")
  public void clickOnGridAddRowLink(String gridName) { fixture.clickOnGridAddRowLink(gridName); }

  @Given("^I click on grid \"([^\"]*)\" navigation \"([^\"]*)\"$")
  public void clickOnGridNavigation(String gridName, String navOption) { fixture.clickOnGridNavigation(gridName, navOption); }

  @Given("^I select all rows in grid \"([^\"]*)\"$")
  public void selectAllRowsInGrid(String gridName) { fixture.selectAllRowsInGrid(gridName); }

  @Given("^I sort grid \"([^\"]*)\" by column \"([^\"]*)\"$")
  public void sortGridByColumn(String gridName, String columnName) { fixture.sortGridByColumn(gridName, columnName); }
  ...
  public void clickOnLink(String linkName) { fixture.clickOnLink(linkName); }
  ...
  public String getLinkURL(String linkName) { return fixture.getLinkURL(linkName); }

  @Given("^I click on icon link \"([^\"]*)\"$")
  public void clickOnIconLink(String iconAltTextName) { fixture.clickOnIconLink(iconAltTextName); }

  @Given("^I click on document image link \"([^\"]*)\"$")
  public void clickOnDocumentImageLink(String documentImageLinkAltTextName) { fixture.clickOnDocumentImageLink(documentImageLinkAltTextName); }

  @Given("^I click on bar chart \"([^\"]*)\" bar \"([^\"]*)\"$")
  public void clickOnBarChartBar(String barChartNumber, String barNumber) { fixture.clickOnBarChartBar(barChartNumber, barNumber); }

  @Given("^I click on column chart \"([^\"]*)\" column \"([^\"]*)\"$")
  public void clickOnColumnChartColumn(String columnChartNumber, String columnNumber) { fixture.clickOnColumnChartColumn(columnChartNumber, columnNumber); }

  @Given("^I click on pie chart \"([^\"]*)\" pie slice \"([^\"]*)\"$")
  public void clickOnPieChartPieSlice(String pieChartNumber, String pieSliceNumber) { fixture.clickOnPieChartPieSlice(pieChartNumber, pieSliceNumber); }

  @Given("^I click on line chart \"([^\"]*)\" point \"([^\"]*)\"$")
  public void clickOnLineChartPoint(String lineChartNumber, String pointNumber) { fixture.clickOnLineChartPoint(lineChartNumber, pointNumber); }

  @Given("^I click on record action field \"([^\"]*)\" menu action \"([^\"]*)\"$")
  public void clickOnRecordActionFieldMenuAction(String indexOfField, String action) { fixture.clickOnRecordActionFieldMenuAction(indexOfField, action); }

  @Given("^I populate dropdown \"([^\"]*)\" search box with \"([^\"]*)\"$")
  public void populateDropdownSearchBoxWith(String fieldName, String searchValue) { fixture.populateDropdownSearchBoxWith(fieldName, searchValue); }
  ...
  public void clickOnButton(String buttonName) { fixture.clickOnButton(buttonName); }

  @Given("^I click on button with tooltip \"([^\"]*)\"$")
  public void clickOnButtonWithTooltip(String tooltip) { fixture.clickOnButtonWithTooltip(tooltip); }
  ...
  public void clickOnSaveChanges() { fixture.clickOnSaveChanges(); }

  @Given("^I click on milestone \"([^\"]*)\" step \"([^\"]*)\"$")
  public void clickOnMilestoneStep(String milestone, String step) { fixture.clickOnMilestoneStep(milestone, step); }

  @Given("^I click on card \"([^\"]*)\"$")
  public void clickOnCard(String linkName) { fixture.clickOnCard(linkName); }
  ...
  public String getMilestoneStep(String milestone) { return fixture.getMilestoneStep(milestone); }

  @Given("^I click on radio option \"([^\"]*)\"$")
  public void clickOnRadioOption(String optionName) { fixture.clickOnRadioOption(optionName); }

  @Given("^I click on checkbox option \"([^\"]*)\"$")
  public void clickOnCheckboxOption(String optionName) { fixture.clickOnCheckboxOption(optionName); }
  ...
  public String getSectionValidationMessage(String sectionName) { return fixture.getSectionValidationMessage(sectionName); }
  ...
  public boolean errorIsPresent() { return fixture.errorIsPresent(); }
  ...
  public static Settings getSettings() { return fixture.getSettings(); }
